...
// echo " $action $radiobx $memberfname $memberlname";
...
//--------------------------------------
   ...
   <table bgcolor='#777777' border='1' width='100%' align='center'>
      <tr>
      <td align='center' >  <a href='blogmembers.php' title='EXIT'><img border='0' src='images/exit.png'    width='20' height='20'></a> </td>
      <td colspan='5' align='center'> <font size='5' color='CYAN' > BLOGs of $memberfname $memberlname</font> </td>
      </tr>
      <tr>
  	...
  	$sql = "SELECT * FROM `$radiobx` ORDER BY ID DESC ";
	...
	while ($field = mysql_fetch_array($res))
	{
	 ...
	 echo "
        ...
        /-->
        <a href='membersblogview.php?&action=MEMBERSBLOGVIEW&MEMBERSACCOUNT=" . $radiobx. "&MEMBERSBLOGID=" . $blogid . "&memberfname=" . $usernamefirst . "&memberlname=" . $usernamelast . "' title='view'><img border='0' src='images/view.png'   width='30' height='30' ></a>
